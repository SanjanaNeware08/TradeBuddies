    ...
    <div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-blue-100 min-h-screen p-6">
        <div className="max-w-4xl mx-auto bg-white p-8 rounded-xl shadow-2xl relative">
          {/* Image Positioned Top Right inside the container */}
          <img
            src="/images/10.jpg" // Replace with your image path in the public folder
            alt="TradeBuddies Logo"
            className="absolute top-4 right-4 w-24 h-auto rounded-lg mb-4"
          />

          <h1 className="text-3xl font-bold text-center text-blue-600 mb-6">Welcome to TradeBuddies!</h1>
